...
Can you spot the pattern?
    ...
    solution: 'alternate upper and lower case letters'
  },
  {
    id: 'puzzle',
    title: 'Logic Puzzle',
  ...
  return (
    <div className="max-w-4xl mx-auto bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold mb-2 text-white">Miscellaneous Challenges</h2>
      ...
      <div className="mb-8">
        ...
        <h3 className="text-xl font-bold mb-2 text-white">{challenges[currentChallenge].title}</h3>
